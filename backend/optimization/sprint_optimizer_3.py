...
class SprintOptimizerNew:
    ...
    def get_optimization_summary(
        ...
        print("Generating optimization summary1...")
        ...
        print("Generating optimization summary2...")
        ...
        print("Generating optimization summary3...")
        ...
        print("Generating optimization summary4...")
        ...
        print("Generating optimization summary5...")
        ...
        print("Generating optimization summary6...")
        ...
        print("Generating optimization summary7...")
        # Extract soft constraint violation values (if problem was solved)
        print("Workload Deviation:",  value(self.workload_deviation))
        print("Max Workload:", value(self.max_workload))
        print("Min Workload:", value(self.min_workload))
        
        
        workload_deviation_value = value(self.workload_deviation) #if self.problem and self.workload_deviation else 0
        max_workload_value = value(self.max_workload) #if self.problem and self.max_workload else 0
        min_workload_value = value(self.min_workload) #if self.problem and self.min_workload else 0
        ...
        print("Generating optimization summary8...")
        ...
        print("Generating optimization summary9...")
